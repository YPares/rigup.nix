let
  firstStep = ''
    1. Make sure the `rigup` CLI tool is installed and up to date:
      - To install: `nix profile add github:YPares/rigup.nix#rigup`
      - To upgrade: `nix profile upgrade rigup --refresh`
  '';
in
{
  default = {

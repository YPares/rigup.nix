{
  ...
  inputs = {
    ...
    # TEMP: For Claude Code: Pinning ref due to https://github.com/numtide/llm-agents.nix/issues/1574
    llm-agents-cc.url = "github:numtide/llm-agents.nix/78eafa553ae1b64eec5e8aa54810568c5cc0de3c";
  };
